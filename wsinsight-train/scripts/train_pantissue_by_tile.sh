...
echo "== pantissue, tile-level split (task=$TASK, nuclei_source=$NUCLEI_SOURCE, segmenter=$HEADLINE_SEGMENTER, transform=$TRANSFORM, val_frac=$VAL_FRAC, architecture=$ARCHITECTURE) =="
